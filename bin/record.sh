...
[ ! -f $file.png ] && gnuplot -p -e "set terminal pngcairo; set output '$file.png'; plot '$file.txt' pt 0 "
...
#[ ! -f $file.smooth.png ] && gnuplot -p -e "set terminal pngcairo; set output '$file.smooth.png'; plot '$file.smooth.txt' pt 0 "
